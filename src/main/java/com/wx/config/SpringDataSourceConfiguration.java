...
@Configuration
@MapperScan(basePackages = {"com.wx.test1"}, sqlSessionFactoryRef = "springSqlSessionFactory")
public class SpringDataSourceConfiguration {
  /**
   * The constant MAPPER_XML_LOCATION.
   */
  public static final String MAPPER_XML_LOCATION = "classpath:com/wx/test1/impl/*.xml";
